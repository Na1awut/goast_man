...
| PromptPay | **จำลอง · ซ่อนในโหมดจริง** | QR เป็นภาพตัวอย่าง ยังไม่ได้ต่อระบบรับเงินจริง · เว็บจริงให้จ่ายเงินสดอย่างเดียว จนกว่าจะตั้ง `PUBLIC_PROMPTPAY_API_URL` (ดู `frontend/src/lib/payments.ts`) · โหมดเดโมยังโชว์ให้สาธิตได้ |
